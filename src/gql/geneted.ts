...
export type CreateSubscriberProps<TChildProps = {}, TDataName extends string = 'mutate'> = {
      [key in TDataName]: Apollo.MutationFunction<CreateSubscriberMutation, CreateSubscriberMutationVariables>
    } & TChildProps;
export function withCreateSubscriber<TProps, TChildProps = {}, TDataName extends string = 'mutate'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  CreateSubscriberMutation,
  CreateSubscriberMutationVariables,
  CreateSubscriberProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withMutation<TProps, CreateSubscriberMutation, CreateSubscriberMutationVariables, CreateSubscriberProps<TChildProps, TDataName>>(CreateSubscriberDocument, {
      alias: 'createSubscriber',
      ...operationOptions
    });
};
...
export const GetLessonBySlugDocument = gql`
  ...
  lesson(where: {slug: $slug}) {
    ...
    `;
export type GetLessonBySlugProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<GetLessonBySlugQuery, GetLessonBySlugQueryVariables>
    } & TChildProps;
export function withGetLessonBySlug<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  GetLessonBySlugQuery,
  GetLessonBySlugQueryVariables,
  GetLessonBySlugProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, GetLessonBySlugQuery, GetLessonBySlugQueryVariables, GetLessonBySlugProps<TChildProps, TDataName>>(GetLessonBySlugDocument, {
      alias: 'getLessonBySlug',
      ...operationOptions
    });
};
...
export const GetLessonsDocument = gql`
  ...
  lessons(orderBy: availableAt_ASC, stage: PUBLISHED) {
    ...
    `;
export type GetLessonsProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<GetLessonsQuery, GetLessonsQueryVariables>
    } & TChildProps;
export function withGetLessons<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  GetLessonsQuery,
  GetLessonsQueryVariables,
  GetLessonsProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, GetLessonsQuery, GetLessonsQueryVariables, GetLessonsProps<TChildProps, TDataName>>(GetLessonsDocument, {
      alias: 'getLessons',
      ...operationOptions
    });
};
